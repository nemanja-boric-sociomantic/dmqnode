...
module swarmnodes.dht.common.request.RedistributeRequest;
...
private import swarmnodes.dht.common.request.params.RedistributeNode;

private import swarmnodes.dht.common.connection.DhtClient;
...
static this ( )
{
    log = Log.lookup("swarmnodes.dht.common.request.RedistributeRequest");
}
...
public scope class RedistributeRequest : IRequest
{
    ...
    ***************************************************************************/
    ...
    private void handleChannel ( DhtClient client, DhtStorageEngine channel )
    {
    ...
    ***************************************************************************/
    ...
    private void advanceIteration ( IStepIterator iterator,
        bool current_forwarded, DhtStorageEngine channel )
    {
