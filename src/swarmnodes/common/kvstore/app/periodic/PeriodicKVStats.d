...
module swarmnodes.common.kvstore.app.periodic.PeriodicKVStats;
...
public class PeriodicKVStats : PeriodicStats
{
    protected alias .IKVNodeInfo IKVNodeInfo;
    ...
    ***************************************************************************/
    ...
    /***************************************************************************
        ...
        Writes the provided fields to the console output line, along with
        key/value specific information.
    ...
    ***************************************************************************/
    ...
    {
        auto node_info = cast(IKVNodeInfo)this.node;

        StaticTrace.format("  {} node 0x{:X16}..0x{:X16}{}: {} conns, {} rec/s, {} recs ({}){}",
