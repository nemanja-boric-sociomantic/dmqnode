/*******************************************************************************
    ...
    Abstract base class for dht node requests which send a sequence of keys or
    key/value pairs to the client. (For example: GetRange, GetAll, GetAllKeys.)
...
module swarmnodes.mod.dht.request.model.IBulkGetRequest;
...
private import swarmnodes.mod.dht.request.model.IChannelRequest;
...
static this ( )
{
    log = Log.lookup("swarmnodes.mod.dht.request.model.IBulkGetRequest");
}
...
public abstract scope class IBulkGetRequest ( bool ChunkedBatcher ) : IChannelRequest
{
    ...
    ***************************************************************************/
    ...
    private void beginIteration ( DhtStorageEngine storage_channel )
    {
    ...
    ***************************************************************************/
    ...
    abstract protected void beginIteration_ ( DhtStorageEngine storage_channel,
