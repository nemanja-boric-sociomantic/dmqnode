...
module swarmnodes.mod.dht.storage.MemoryStorageChannels;
...
private import swarmnodes.mod.dht.storage.model.DhtStorageEngine;

private import swarmnodes.mod.dht.storage.model.IStepIterator;

private import swarmnodes.mod.dht.storage.memory.DumpManager;

private import swarmnodes.mod.dht.storage.memory.MemoryStorage;
...
static this ( )
{
    log = Log.lookup("swarmnodes.mod.dht.storage.MemoryStorageChannels");
}
