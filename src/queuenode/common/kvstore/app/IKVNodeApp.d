/*******************************************************************************
    ...
    Key/value node base class - contains members which are shared by both types
    of node, including an instance of KVNode, which is the node derived from the
    node base classes in swarm.

*******************************************************************************/

module queuenode.common.kvstore.app.IKVNodeApp;
...
private import queuenode.common.kvstore.app.config.ServerConfig;
...
private import queuenode.common.kvstore.app.config.HashRangeConfig;

private import queuenode.common.kvstore.node.KVNode;
...
static this ( )
{
    log = Log.lookup("queuenode.common.kvstore.app.IKVNodeApp");
}
...
abstract public class IKVNodeApp ( ConnHandler ) : LoggedCliApp
{
    ...
    ***************************************************************************/
    ...
    protected alias .KVStorageChannels KVStorageChannels;
    ...
    ***************************************************************************/
    ...
    protected KVStorageChannels storage_channels;
    ...
    ***************************************************************************/
    ...
    protected KVHashRange hash_range;
    ...
    ***************************************************************************/
    ...
    public this ( )
    {
        const app_name = "kvnode";
        const app_desc = "kvnode: key/value server node.";
        const usage = null;
        const help = null;
    ...
    ***************************************************************************/
    ...
    public override void processConfig ( IApplication app, ConfigParser config )
    {
        ...
        this.hash_range = new KVHashRange(min, max,
    ...
    ***************************************************************************/
    ...
    protected int run ( Arguments args, ConfigParser config )
    {
        ...
        log.info("Starting key/value node --------------------------------");
    ...
    ***************************************************************************/
    ...
    final protected KVStorageChannels newStorageChannels ( )
    {
        this.storage_channels = this.newStorageChannels_();
        return this.storage_channels;
    }

    abstract protected KVStorageChannels newStorageChannels_ ( );
