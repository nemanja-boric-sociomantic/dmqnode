...
module queuenode.logfiles.main;
...
private import queuenode.common.kvstore.app.IKVNodeApp;

private import queuenode.common.kvstore.app.periodic.PeriodicKVStats;

private import queuenode.logfiles.connection.LogfilesConnectionHandler;

private import queuenode.logfiles.storage.LogFilesStorageChannels;

private import queuenode.logfiles.storage.LogRecordPut;
...
static this ( )
{
    log = Log.lookup("queuenode.logfiles.main");
}
