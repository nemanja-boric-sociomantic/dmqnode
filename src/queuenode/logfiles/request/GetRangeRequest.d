...
module queuenode.logfiles.request.GetRangeRequest;
...
private scope class GetRangeRequest : IBulkGetRequest
{
    /***************************************************************************
    ...
    ***************************************************************************/
    ...
    {
        super(DhtConst.Command.E.GetRange, reader, writer, resources);
    }
