...
private import queuenode.dht.connection.DhtConnectionHandler;

private import queuenode.common.util.Terminator;

private import queuenode.dht.app.periodic.MemoryPeriodicStats;
private import queuenode.dht.app.periodic.ChannelDumpThread;

private import queuenode.dht.storage.MemoryStorageChannels;
...
static this ( )
{
    log = Log.lookup("queuenode.dht.main");
}
